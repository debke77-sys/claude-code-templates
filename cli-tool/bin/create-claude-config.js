...
program
  ...
  .option('--clean-chats', 'clean up local Claude Code conversations (empty, old, or manually selected)')
  .option('--empty-chats', 'target empty conversations when used with --clean-chats')
  .option('--older-than <days>', 'target conversations older than N days when used with --clean-chats')
